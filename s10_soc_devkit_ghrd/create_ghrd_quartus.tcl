...
set_instance_assignment -name PRESERVE_FANOUT_FREE_NODE ON -to *std_sync_no_cut|din_s1
set_instance_assignment -name PRESERVE_FANOUT_FREE_NODE ON -to *alt_mge16_pcs_reset_synchronizer_chain
set_instance_assignment -name PRESERVE_FANOUT_FREE_NODE ON -to *cntr_b_clock_crosser|out_data_buffer
}

...
set_clock_groups -asynchronous -group [get_clocks {*|enet_iopll_0|*outclk0}] -group [get_clocks {*|enet_iopll_0|*outclk1}] -group [get_clocks {*|enet_iopll_0|*outclk2}] -group [get_clocks {hps_emac*_gtx_clk}]
